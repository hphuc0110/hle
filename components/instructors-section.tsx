        ...
        <div className="bg-white rounded-2xl p-6 md:p-12 shadow-2xl relative">
          ...
          >
            {teachers.map((teacher) => (
              <div
                key={teacher.id}
                className="bg-gradient-to-br from-red-50 to-purple-100 rounded-xl p-6 hover:scale-105 transition-transform duration-300 flex-shrink-0 w-80 snap-center"
              >
                <div className="aspect-[3/4] overflow-hidden rounded-lg mb-4 mx-auto max-w-[300px]">
                  <img
                ...
                <div>
                  <p className="text-[cd0000] text-sm font-medium mb-1">{teacher.title}</p>
